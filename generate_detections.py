...
if __name__ == '__main__':
    ...
    cfg.MODEL.WEIGHTS = '/home/jiaruili/Documents/github/fast-reid/resources/fast-reid/duke_bot_S50.pth'
    cfg.OUTPUT_DIR = '/home/jiaruili/Documents/exp/advTraj/baselines/parallel_baseline_atk/det_feats'
    ...
    root_img = '/home/jiaruili/Documents/exp/advTraj/baselines/parallel_baseline_atk/imgs'
    ...
    dir_in_det = '/home/jiaruili/Documents/exp/advTraj/baselines/parallel_baseline_atk/dets'
    ...
    for i, file in enumerate(files, start=1):
        # if i <= 5: continue
        video = split(file)[1][:-8]
        print('processing the video {}...'.format(video))

        dir_img = join(root_img, '{}'.format(video))
        ...
        for frame in range(mim_frame, max_frame + 1):
            ...
            img = Image.open(join(dir_img, '%d.jpg' % frame))
